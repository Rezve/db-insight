...
import { Maximize2, Info, X, AlertCircle, Lightbulb, Copy, Check } from "lucide-react";
...
function MissingIndexBanner({ hints }: { hints: MissingIndexHint[] }) {
            ...
            <div key={i} className="flex items-start justify-between gap-3 px-3 py-2">
              ...
              <div className="flex items-center gap-2 shrink-0">
                ...
                <Button
                  size="sm"
                  variant="ghost"
                  className="h-6 w-6 p-0 hover:bg-amber-200 dark:hover:bg-amber-800/50 text-amber-700 dark:text-amber-400"
...
export default function QueryPlanVisualizer({ planXml }: QueryPlanVisualizerProps) {
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <MissingIndexBanner hints={missingIndexes} />
